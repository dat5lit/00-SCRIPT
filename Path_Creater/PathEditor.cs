...
{ 
    ...
    protected virtual void OnSceneGUI()
    {
        ...
        for (int i = 0; i < t.List_Points.Count; i++)
        {
            ...
            var fmh_48_65_638789227192154943 = Quaternion.identity; Vector3 newPoint = Handles.FreeMoveHandle(oldPoint, .5f, new Vector3(.25f, .25f, .25f), Handles.CircleHandleCap);
